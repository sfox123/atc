              ...
              <div className="col-md-6">
                <div className="text">
                  ...
                  Choose Our Products & {' '}
                    ...
                    <span className="fw-300">Best</span>
                  </h3>
                  <p>
                  ATC prides itself in being the most trusted aluminum brand in Sri Lanka. Rooted in over three decades of expertise and undisputed market leadership,
                  </p>
